...
export function App() {
    ...
    // ============================================================
    // FUNCIÓN PARA NUEVO CHAT (estilo ChatGPT)
    // ============================================================
    const handleNewChat = () => {
    ...
    // ============================================================
    // FUNCIÓN PARA VOLVER AL INICIO (sin perder el contexto)
    // ============================================================
    const goToHome = () => {
        ...
        <ThemeProvider theme={darkTheme}>
            ...
            <AppBar position="static" sx={{ 
                ...
                <Toolbar sx={{
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        {/* Botón "Nuevo chat" - estilo ChatGPT */}
                        {loadFinished && (
            ...
            <Container sx={{
                ...
                <Box sx={{ flexGrow: 1, overflowY: 'auto', py: 2 }}>
                    ...
                    {/* ============================================================
                        PANTALLA DE INICIO - Solo cuando NO hay mensajes
                    ============================================================ */}
            ...
            {/* ============================================================
                BOTÓN FLOTANTE - Solo cuando hay mensajes
                Al hacer scroll hacia arriba, lleva al inicio del chat
            ============================================================ */}
            {loadFinished && messageHistory.length > 0 && (
                <Zoom in>
