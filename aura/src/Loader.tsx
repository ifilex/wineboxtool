...
export function App() {
    ...
    // ============================================================
    // ESTADOS PARA ANIMACIÓN DE CARGA
    // ============================================================
    ...
    // ============================================================
    // FRASES DE CARGA (para hacerla más amena)
    // ============================================================
    const loadingPhrases = [
        '🧠 Despertando neuronas...',
        '🌿 Preparando tu espacio de bienestar...',
        '💭 Conectando con Aura...',
        '✨ Cargando sabiduría cognitiva...',
    ...
    }, [loadFinished, criticalError, loadingStage]);

    // ============================================================
    // CUANDO TERMINA LA CARGA, COMPLETAR PROGRESO
    // ============================================================
    useEffect(() => {
        if (loadFinished) {
    ...
    useEffect(() => {
        const initApp = async () => {
            try {
                setLoadingText('🔄 Verificando WebGPU...');
                ...
                if (localStorage.getItem('downloaded_models')) {
                    ...
                    setLoadingText('📥 Cargando modelo desde caché...');
    ...
    // ============================================================
    // RENDER - PANTALLA DE CARGA MEJORADA
    // ============================================================
    if (!loadFinished && !criticalError) {
        return (
            <ThemeProvider theme={darkTheme}>
                ...
                <Box sx={{
                    ...
                    >
                        {downloadStatus || 'Preparando entorno...'}
                    </Typography>
                    ...
                    {/* Botón de descarga (solo si no hay modelo) */}
                    {!alreadyFromCache && !localStorage.getItem('downloaded_models') && (
                        <Button
                            variant="outlined"
                            onClick={() => {
                                setLoadingText('📥 Descargando modelo...');
